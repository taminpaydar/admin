...
export default function ArticleGroup() {
    ...
    const exportexcel =()=>{
        axios.get(`${config.url}/v1/dashboard/exportexcel`, {
            headers: {
                Authorization: 'Bearer ' + cookie['token'],
        ...
        <Container>
            ...
            <Box mb={3}>
                <Button variant={'contained'} color={'inherit'} onClick={(e)=>{
                    ...
                    <img src="/assets/excel.svg" width={20}></img> خروجی اکسل
                </Button>
            </Box>
                                ...
                                {article.docs.map((row: any) => (
                                    ...
                                    >
                                        ...
                                        <TableCell align="right">
                                            <TextField defaultValue={row.price}></TextField>
                                        </TableCell>
                                        <TableCell align="right">
                                            {
                                                    ...
                                                    return (
                                                        ...
                                                        <Typography fontWeight={'bold'} fontSize={14}>{ item.title }</Typography>
                                                        {
                                                            item.toprices.map((p:any)=>{
                                                                ...
                                                                <TextField size="small" defaultValue={p.price}></TextField>
