...
import { ArrowDownward, ArrowUpward, DeleteForever, Edit } from "@mui/icons-material";
type Repo = any;
...
export default function ItemEdit({
    ...
    const reload = async () => {
        ...
        try {
            let res: any = await axios({
                method: 'get',
                url: config.url + '/v1/dashboard/price/list/' + myid,
                data: data,
                headers: {
                    Authorization: 'Bearer ' + cookie['token'],
                }
                ...
                <Paper>
                    ...
                    <Box p={3}>
                        ...
                        <Stack direction="row" spacing={2} >
                            <Box p={2}>
                                <Button variant={'outlined'} href={`/Dashboard/Products/ItemsPrice/new/${repo.message.id}`}> {i18n.t('add price')} </Button>
                                ...
                                <TableBody>
                                    {list != null && list.message.map((row: any) => (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">
                                                <Link href={`/Dashboard/Products/ItemsPrice/edit/${row._id}`}>
                                                    <Edit></Edit>
                                                </Link>
