...
export default function ArticleGroup() {
    ...
    const LoadArticle = (current: any, parent: any) => {
        console.log(parent);
        axios.get(`${config.url}/v1/dashboard/discountcode?&page=${current}&name=${namefilter}`, {
            headers: {
    ...
    const deleteItem = (id: String) => {
        axios.delete(`${config.url}/v1/dashboard/discountcode/${id}`, {
            headers: {
                Authorization: 'Bearer ' + cookie['token'],
    ...
    return <Layout>
        <Container>
            ...
            <Grid container>
                ...
                <Grid xs={6} md={2} pr={1} pl={1} >
                    <Link href={`/Dashboard/Products/Discount/new`}>
