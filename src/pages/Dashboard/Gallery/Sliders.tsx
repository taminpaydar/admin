...
export default function ArticleGroup() {
    ...
    const LoadArticle = (current: any) => {
        console.log(current);
        axios.get(`${config.url}/v1/dashboard/slider?page=${current}`, {
            headers: {
    ...
    const deleteItem = (id:String) =>{
        axios.delete(`${config.url}/v1/dashboard/slider/${id}`, {
            headers: {
                Authorization: 'Bearer ' + cookie['token'],
            ...
            <Typography fontSize={'28px'} mt={4} mb={3} fontWeight={'bold'}>
                ...
                <Grid container>
                    ...
                    <Grid xs={6} md={2} pr={1} pl={1} >
                        <Link href="/Dashboard/Gallery/Sliders/new">
                                ...
                                {article.docs.map((row: any) => (
                                    ...
                                    >
                                        ...
                                        <TableCell align="right">
                                            <Link href={`/Dashboard/Gallery/Sliders/${row.id}`}>
